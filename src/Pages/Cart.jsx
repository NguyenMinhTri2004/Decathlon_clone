...
const Cart = () => {
  ...
  let cartListTmp = useSelector((state) => state.cartItems.value);
  ...
  cartItems?.map((item) => (sumquantity += item.quantity));

  const cartToTal = cartList?.reduce(
    (total, item) => total + Number(item.quantity) * Number(item.product[0].money), 0)
        ...
        <div className="cart__wrapper">
          <div className="cart__left">
            <div className="cart__left__address">
              <p>
                Giao hàng đến <strong>Hồ Chí Minh Quận 1</strong>{" "}
              </p>
              <span>THAY ĐỔI</span>
            </div>
            ...
            <div className="cart__left__endow">
              <div className="cart__left__endow__wrapper">
                ...
                <div className="cart__left__endow__item">
                  ...
                  <p>
                    Mua thêm 774,001 VND để được MIỄN PHÍ GIAO HÀNG (Tối đa
                    100,000)
                  </p>
                </div>
              </div>
          ...
          <div className="cart__right">
            <div className="cart__right__bill">
              <div className="cart__right__bill__top">
                ...
                <div className="cart__right__bill__top__item">
                  <p>Tạm tính</p>
                  <p>{numberWithCommas(cartToTal || 0)} VND</p>
                </div>
              ...
              <div className="cart__right__bill__bottom">
                <div className="cart__right__bill__bottom__item">
                  ...
                  <strong>{numberWithCommas(cartToTal || 0)} VND</strong>
                </div>
              </div>
            </div>
            <Button backgroundColor={"yellow"} onClick={() => Gocheckout()}>
              TIẾP TỤC
            </Button>
